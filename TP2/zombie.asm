...
main(void)
{
  ...
  1d:	6a 05                	push   $0x5
  1f:	e8 e7 02 00 00       	call   30b <sleep>
  24:	83 c4 10             	add    $0x10,%esp
  exit();
  27:	e8 4f 02 00 00       	call   27b <exit>
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 159:	31 db                	xor    %ebx,%ebx
{
 ...
 165:	56                   	push   %esi
 166:	6a 00                	push   $0x0
 168:	e8 26 01 00 00       	call   293 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1bd:	e8 f9 00 00 00       	call   2bb <open>
  if(fd < 0)
 ...
 1d1:	50                   	push   %eax
 1d2:	e8 fc 00 00 00       	call   2d3 <fstat>
  close(fd);
...
00000273 <forkcow>:
SYSCALL(forkcow)
 273:	b8 16 00 00 00       	mov    $0x16,%eax
 278:	cd 40                	int    $0x40
 27a:	c3                   	ret
 ...
 348:	89 d1                	mov    %edx,%ecx
{
 ...
 3b6:	50                   	push   %eax
 3b7:	56                   	push   %esi
 3b8:	e8 de fe ff ff       	call   29b <write>
  while(--i >= 0)
 ...
 3e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 420:	50                   	push   %eax
 421:	57                   	push   %edi
 422:	e8 74 fe ff ff       	call   29b <write>
 ...
 480:	57                   	push   %edi
 481:	e8 15 fe ff ff       	call   29b <write>
 ...
 491:	52                   	push   %edx
 492:	57                   	push   %edi
 493:	e8 03 fe ff ff       	call   29b <write>
        putc(fd, c);
 ...
 4fb:	53                   	push   %ebx
 4fc:	57                   	push   %edi
 4fd:	e8 99 fd ff ff       	call   29b <write>
        while(*s != 0){
 ...
 53a:	52                   	push   %edx
 53b:	57                   	push   %edi
 53c:	e8 5a fd ff ff       	call   29b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 656:	56                   	push   %esi
 657:	e8 a7 fc ff ff       	call   303 <sbrk>
  if(p == (char*)-1)
