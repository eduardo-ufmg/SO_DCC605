...
main(int argc, char **argv)
{
  ...
  39:	e8 9d 02 00 00       	call   2db <kill>
  for(i=1; i<argc; i++)
  3e:	83 c4 10             	add    $0x10,%esp
  41:	39 de                	cmp    %ebx,%esi
  43:	75 e3                	jne    28 <main+0x28>
  exit();
  45:	e8 61 02 00 00       	call   2ab <exit>
    printf(2, "usage: kill pid...\n");
  4a:	50                   	push   %eax
  4b:	50                   	push   %eax
  ...
  53:	e8 b8 03 00 00       	call   410 <printf>
    exit();
  58:	e8 4e 02 00 00       	call   2ab <exit>
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 189:	31 db                	xor    %ebx,%ebx
{
 ...
 195:	56                   	push   %esi
 196:	6a 00                	push   $0x0
 198:	e8 26 01 00 00       	call   2c3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ed:	e8 f9 00 00 00       	call   2eb <open>
  if(fd < 0)
 ...
 201:	50                   	push   %eax
 202:	e8 fc 00 00 00       	call   303 <fstat>
  close(fd);
 207:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 20a:	89 c6                	mov    %eax,%esi
  close(fd);
 20c:	e8 c2 00 00 00       	call   2d3 <close>
  return r;
 ...
 378:	89 d1                	mov    %edx,%ecx
{
 ...
 3e6:	50                   	push   %eax
 3e7:	56                   	push   %esi
 3e8:	e8 de fe ff ff       	call   2cb <write>
  while(--i >= 0)
 ...
 419:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 450:	50                   	push   %eax
 451:	57                   	push   %edi
 452:	e8 74 fe ff ff       	call   2cb <write>
 ...
 4b0:	57                   	push   %edi
 4b1:	e8 15 fe ff ff       	call   2cb <write>
 ...
 4c1:	52                   	push   %edx
 4c2:	57                   	push   %edi
 4c3:	e8 03 fe ff ff       	call   2cb <write>
        putc(fd, c);
 ...
 52b:	53                   	push   %ebx
 52c:	57                   	push   %edi
 52d:	e8 99 fd ff ff       	call   2cb <write>
        while(*s != 0){
 ...
 56a:	52                   	push   %edx
 56b:	57                   	push   %edi
 56c:	e8 5a fd ff ff       	call   2cb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 686:	56                   	push   %esi
 687:	e8 a7 fc ff ff       	call   333 <sbrk>
  if(p == (char*)-1)
