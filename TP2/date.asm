   ...
   e:	8d 45 e0             	lea    -0x20(%ebp),%eax
{
  ...
  if (date(&r)) {
  14:	50                   	push   %eax
  15:	e8 41 03 00 00       	call   35b <date>
  ...
  21:	50                   	push   %eax
  22:	50                   	push   %eax
  23:	68 28 07 00 00       	push   $0x728
  28:	ff 35 54 0a 00 00    	push   0xa54
  2e:	e8 ed 03 00 00       	call   420 <printf>
    exit();
  33:	e8 83 02 00 00       	call   2bb <exit>
  }

  printf(stdout, "%d-%d-%d %d:%d:%d\n", r.year, r.month, r.day, r.hour, r.minute, r.second);
  38:	ff 75 e0             	push   -0x20(%ebp)
  3b:	ff 75 e4             	push   -0x1c(%ebp)
  3e:	ff 75 e8             	push   -0x18(%ebp)
  41:	ff 75 ec             	push   -0x14(%ebp)
  44:	ff 75 f0             	push   -0x10(%ebp)
  47:	ff 75 f4             	push   -0xc(%ebp)
  4a:	68 44 07 00 00       	push   $0x744
  4f:	ff 35 58 0a 00 00    	push   0xa58
  55:	e8 c6 03 00 00       	call   420 <printf>

  exit();
  5a:	83 c4 20             	add    $0x20,%esp
  5d:	e8 59 02 00 00       	call   2bb <exit>
  62:	66 90                	xchg   %ax,%ax
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
 ...
 199:	31 db                	xor    %ebx,%ebx
{
 ...
 1a5:	56                   	push   %esi
 1a6:	6a 00                	push   $0x0
 1a8:	e8 26 01 00 00       	call   2d3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1fd:	e8 f9 00 00 00       	call   2fb <open>
  if(fd < 0)
 ...
 211:	50                   	push   %eax
 212:	e8 fc 00 00 00       	call   313 <fstat>
  close(fd);
 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3f6:	50                   	push   %eax
 3f7:	56                   	push   %esi
 3f8:	e8 de fe ff ff       	call   2db <write>
  while(--i >= 0)
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 460:	50                   	push   %eax
 461:	57                   	push   %edi
 462:	e8 74 fe ff ff       	call   2db <write>
 ...
 4c0:	57                   	push   %edi
 4c1:	e8 15 fe ff ff       	call   2db <write>
 ...
 4d1:	52                   	push   %edx
 4d2:	57                   	push   %edi
 4d3:	e8 03 fe ff ff       	call   2db <write>
        putc(fd, c);
 ...
 53b:	53                   	push   %ebx
 53c:	57                   	push   %edi
 53d:	e8 99 fd ff ff       	call   2db <write>
        while(*s != 0){
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb 57 07 00 00       	mov    $0x757,%ebx
...
free(void *ap)
{
 ...
 5b1:	a1 5c 0a 00 00       	mov    0xa5c,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 5c 0a 00 00       	mov    %eax,0xa5c
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 5c 0a 00 00       	mov    %eax,0xa5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 5c 0a 00 00    	cmp    0xa5c,%eax
 691:	75 ed                	jne    680 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 693:	83 ec 0c             	sub    $0xc,%esp
 696:	56                   	push   %esi
 697:	e8 a7 fc ff ff       	call   343 <sbrk>
  if(p == (char*)-1)
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 5c 0a 00 00    	mov    0xa5c,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 5c 0a 00 00    	mov    %edx,0xa5c
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 5c 0a 00 00 60 	movl   $0xa60,0xa5c
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 60 0a 00 00       	mov    $0xa60,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 60 0a 00 00 60 	movl   $0xa60,0xa60
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 64 0a 00 00 00 	movl   $0x0,0xa64
 710:	00 00 00 
    if(p->s.size >= nunits){
