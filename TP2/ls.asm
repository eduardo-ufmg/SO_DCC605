...
main(int argc, char *argv[])
{
  ...
  exit();
  3d:	e8 39 05 00 00       	call   57b <exit>
    ls(".");
  42:	83 ec 0c             	sub    $0xc,%esp
  45:	68 30 0a 00 00       	push   $0xa30
  4a:	e8 b1 00 00 00       	call   100 <ls>
    exit();
  4f:	e8 27 05 00 00       	call   57b <exit>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
...
00000100 <ls>:
{
 ...
 10f:	6a 00                	push   $0x0
 111:	57                   	push   %edi
 112:	e8 a4 04 00 00       	call   5bb <open>
 ...
 12d:	56                   	push   %esi
 12e:	50                   	push   %eax
 12f:	e8 9f 04 00 00       	call   5d3 <fstat>
 ...
 18c:	53                   	push   %ebx
 18d:	e8 11 04 00 00       	call   5a3 <close>
 ...
 1fb:	50                   	push   %eax
 1fc:	53                   	push   %ebx
 1fd:	e8 91 03 00 00       	call   593 <read>
 ...
 303:	e8 9b 02 00 00       	call   5a3 <close>
    return;
 ...
 459:	31 db                	xor    %ebx,%ebx
{
 ...
 465:	56                   	push   %esi
 466:	6a 00                	push   $0x0
 468:	e8 26 01 00 00       	call   593 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 4bd:	e8 f9 00 00 00       	call   5bb <open>
  if(fd < 0)
 ...
 4d1:	50                   	push   %eax
 4d2:	e8 fc 00 00 00       	call   5d3 <fstat>
  close(fd);
 4d7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 4da:	89 c6                	mov    %eax,%esi
  close(fd);
 4dc:	e8 c2 00 00 00       	call   5a3 <close>
  return r;
 ...
 648:	89 d1                	mov    %edx,%ecx
{
 ...
 6b6:	50                   	push   %eax
 6b7:	56                   	push   %esi
 6b8:	e8 de fe ff ff       	call   59b <write>
  while(--i >= 0)
 ...
 6e9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 720:	50                   	push   %eax
 721:	57                   	push   %edi
 722:	e8 74 fe ff ff       	call   59b <write>
 ...
 780:	57                   	push   %edi
 781:	e8 15 fe ff ff       	call   59b <write>
 ...
 791:	52                   	push   %edx
 792:	57                   	push   %edi
 793:	e8 03 fe ff ff       	call   59b <write>
        putc(fd, c);
 ...
 7fb:	53                   	push   %ebx
 7fc:	57                   	push   %edi
 7fd:	e8 99 fd ff ff       	call   59b <write>
        while(*s != 0){
 ...
 83a:	52                   	push   %edx
 83b:	57                   	push   %edi
 83c:	e8 5a fd ff ff       	call   59b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 956:	56                   	push   %esi
 957:	e8 a7 fc ff ff       	call   603 <sbrk>
  if(p == (char*)-1)
