...
main(int argc, char *argv[])
{
  ...
  3d:	ff 33                	push   (%ebx)
  3f:	e8 d7 02 00 00       	call   31b <unlink>
  ...
  exit();
  5d:	e8 69 02 00 00       	call   2cb <exit>
    printf(2, "Usage: rm files...\n");
  62:	52                   	push   %edx
  63:	52                   	push   %edx
  ...
  6b:	e8 c0 03 00 00       	call   430 <printf>
    exit();
  70:	e8 56 02 00 00       	call   2cb <exit>
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 db                	xor    %ebx,%ebx
{
 ...
 1b5:	56                   	push   %esi
 1b6:	6a 00                	push   $0x0
 1b8:	e8 26 01 00 00       	call   2e3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 20d:	e8 f9 00 00 00       	call   30b <open>
  if(fd < 0)
 ...
 221:	50                   	push   %eax
 222:	e8 fc 00 00 00       	call   323 <fstat>
  close(fd);
 ...
 398:	89 d1                	mov    %edx,%ecx
{
 ...
 406:	50                   	push   %eax
 407:	56                   	push   %esi
 408:	e8 de fe ff ff       	call   2eb <write>
  while(--i >= 0)
 ...
 439:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 470:	50                   	push   %eax
 471:	57                   	push   %edi
 472:	e8 74 fe ff ff       	call   2eb <write>
 ...
 4d0:	57                   	push   %edi
 4d1:	e8 15 fe ff ff       	call   2eb <write>
 ...
 4e1:	52                   	push   %edx
 4e2:	57                   	push   %edi
 4e3:	e8 03 fe ff ff       	call   2eb <write>
        putc(fd, c);
 ...
 54b:	53                   	push   %ebx
 54c:	57                   	push   %edi
 54d:	e8 99 fd ff ff       	call   2eb <write>
        while(*s != 0){
 ...
 58a:	52                   	push   %edx
 58b:	57                   	push   %edi
 58c:	e8 5a fd ff ff       	call   2eb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 6a6:	56                   	push   %esi
 6a7:	e8 a7 fc ff ff       	call   353 <sbrk>
  if(p == (char*)-1)
