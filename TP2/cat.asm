...
main(int argc, char *argv[])
{
  ...
  42:	e8 3c 03 00 00       	call   383 <close>
  for(i = 1; i < argc; i++){
  ...
  52:	6a 00                	push   $0x0
  54:	ff 33                	push   (%ebx)
  56:	e8 40 03 00 00       	call   39b <open>
  ...
  6e:	e8 4d 04 00 00       	call   4c0 <printf>
      exit();
  73:	e8 e3 02 00 00       	call   35b <exit>
  }
  exit();
  78:	e8 de 02 00 00       	call   35b <exit>
    cat(0);
  7d:	83 ec 0c             	sub    $0xc,%esp
  80:	6a 00                	push   $0x0
  82:	e8 09 00 00 00       	call   90 <cat>
    exit();
  87:	e8 cf 02 00 00       	call   35b <exit>
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
...
00000090 <cat>:
{
  ...
  a9:	6a 01                	push   $0x1
  ab:	e8 cb 02 00 00       	call   37b <write>
  ...
  c4:	56                   	push   %esi
  c5:	e8 a9 02 00 00       	call   373 <read>
  ...
  e6:	e8 d5 03 00 00       	call   4c0 <printf>
      exit();
  eb:	e8 6b 02 00 00       	call   35b <exit>
  ...
  f9:	e8 c2 03 00 00       	call   4c0 <printf>
    exit();
  fe:	e8 58 02 00 00       	call   35b <exit>
 ...
 239:	31 db                	xor    %ebx,%ebx
{
 ...
 245:	56                   	push   %esi
 246:	6a 00                	push   $0x0
 248:	e8 26 01 00 00       	call   373 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 29d:	e8 f9 00 00 00       	call   39b <open>
  if(fd < 0)
 ...
 2b1:	50                   	push   %eax
 2b2:	e8 fc 00 00 00       	call   3b3 <fstat>
  close(fd);
 2b7:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 2ba:	89 c6                	mov    %eax,%esi
  close(fd);
 2bc:	e8 c2 00 00 00       	call   383 <close>
  return r;
 ...
 428:	89 d1                	mov    %edx,%ecx
{
 ...
 496:	50                   	push   %eax
 497:	56                   	push   %esi
 498:	e8 de fe ff ff       	call   37b <write>
  while(--i >= 0)
 ...
 4c9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 500:	50                   	push   %eax
 501:	57                   	push   %edi
 502:	e8 74 fe ff ff       	call   37b <write>
 ...
 560:	57                   	push   %edi
 561:	e8 15 fe ff ff       	call   37b <write>
 ...
 571:	52                   	push   %edx
 572:	57                   	push   %edi
 573:	e8 03 fe ff ff       	call   37b <write>
        putc(fd, c);
 ...
 5db:	53                   	push   %ebx
 5dc:	57                   	push   %edi
 5dd:	e8 99 fd ff ff       	call   37b <write>
        while(*s != 0){
 ...
 61a:	52                   	push   %edx
 61b:	57                   	push   %edi
 61c:	e8 5a fd ff ff       	call   37b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 736:	56                   	push   %esi
 737:	e8 a7 fc ff ff       	call   3e3 <sbrk>
  if(p == (char*)-1)
