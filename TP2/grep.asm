...
main(int argc, char *argv[])
{
  ...
  55:	e8 b9 05 00 00       	call   613 <close>
  for(i = 2; i < argc; i++){
  ...
  65:	6a 00                	push   $0x0
  67:	ff 33                	push   (%ebx)
  69:	e8 bd 05 00 00       	call   62b <open>
  ...
  81:	e8 ca 06 00 00       	call   750 <printf>
      exit();
  86:	e8 60 05 00 00       	call   5eb <exit>
  }
  exit();
  8b:	e8 5b 05 00 00       	call   5eb <exit>
    printf(2, "usage: grep pattern [file ...]\n");
  90:	51                   	push   %ecx
  91:	51                   	push   %ecx
  ...
  99:	e8 b2 06 00 00       	call   750 <printf>
    exit();
  9e:	e8 48 05 00 00       	call   5eb <exit>
    grep(pattern, 0);
  a3:	52                   	push   %edx
  a4:	52                   	push   %edx
  a5:	6a 00                	push   $0x0
  ...
  a8:	e8 43 01 00 00       	call   1f0 <grep>
    exit();
  ad:	e8 39 05 00 00       	call   5eb <exit>
  b2:	66 90                	xchg   %ax,%ax
  b4:	66 90                	xchg   %ax,%ax
  b6:	66 90                	xchg   %ax,%ax
  b8:	66 90                	xchg   %ax,%ax
 ...
 1f4:	31 ff                	xor    %edi,%edi
{
 ...
 228:	e8 d6 03 00 00       	call   603 <read>
 ...
 2b0:	6a 01                	push   $0x1
 2b2:	e8 54 03 00 00       	call   60b <write>
 ...
 4c9:	31 db                	xor    %ebx,%ebx
{
 ...
 4d5:	56                   	push   %esi
 4d6:	6a 00                	push   $0x0
 4d8:	e8 26 01 00 00       	call   603 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 52d:	e8 f9 00 00 00       	call   62b <open>
  if(fd < 0)
 ...
 541:	50                   	push   %eax
 542:	e8 fc 00 00 00       	call   643 <fstat>
  close(fd);
 547:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 54a:	89 c6                	mov    %eax,%esi
  close(fd);
 54c:	e8 c2 00 00 00       	call   613 <close>
  return r;
 ...
 6b8:	89 d1                	mov    %edx,%ecx
{
 ...
 726:	50                   	push   %eax
 727:	56                   	push   %esi
 728:	e8 de fe ff ff       	call   60b <write>
  while(--i >= 0)
 ...
 759:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 790:	50                   	push   %eax
 791:	57                   	push   %edi
 792:	e8 74 fe ff ff       	call   60b <write>
 ...
 7f0:	57                   	push   %edi
 7f1:	e8 15 fe ff ff       	call   60b <write>
 ...
 801:	52                   	push   %edx
 802:	57                   	push   %edi
 803:	e8 03 fe ff ff       	call   60b <write>
        putc(fd, c);
 ...
 86b:	53                   	push   %ebx
 86c:	57                   	push   %edi
 86d:	e8 99 fd ff ff       	call   60b <write>
        while(*s != 0){
 ...
 8aa:	52                   	push   %edx
 8ab:	57                   	push   %edi
 8ac:	e8 5a fd ff ff       	call   60b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 9c6:	56                   	push   %esi
 9c7:	e8 a7 fc ff ff       	call   673 <sbrk>
  if(p == (char*)-1)
