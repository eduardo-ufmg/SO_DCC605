...
main(void)
{
  ...
  19:	e8 5d 03 00 00       	call   37b <open>
  ...
  2c:	6a 00                	push   $0x0
  2e:	e8 80 03 00 00       	call   3b3 <dup>
  dup(0);  // stderr
  33:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  3a:	e8 74 03 00 00       	call   3b3 <dup>
  ...
  70:	e8 ce 02 00 00       	call   343 <wait>
  ...
  91:	53                   	push   %ebx
  92:	53                   	push   %ebx
  93:	68 c3 07 00 00       	push   $0x7c3
  98:	6a 01                	push   $0x1
  9a:	e8 01 04 00 00       	call   4a0 <printf>
      exit();
  9f:	e8 97 02 00 00       	call   33b <exit>
      exec("sh", argv);
  a4:	50                   	push   %eax
  a5:	50                   	push   %eax
  a6:	68 f8 0a 00 00       	push   $0xaf8
  ab:	68 d6 07 00 00       	push   $0x7d6
  b0:	e8 be 02 00 00       	call   373 <exec>
      printf(1, "init: exec sh failed\n");
  b5:	5a                   	pop    %edx
  b6:	59                   	pop    %ecx
  b7:	68 d9 07 00 00       	push   $0x7d9
  bc:	6a 01                	push   $0x1
  be:	e8 dd 03 00 00       	call   4a0 <printf>
      exit();
  c3:	e8 73 02 00 00       	call   33b <exit>
    mknod("console", 1, 1);
  c8:	50                   	push   %eax
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 a8 07 00 00       	push   $0x7a8
  d2:	e8 ac 02 00 00       	call   383 <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 a8 07 00 00       	push   $0x7a8
  e0:	e8 96 02 00 00       	call   37b <open>
 ...
 219:	31 db                	xor    %ebx,%ebx
{
 ...
 225:	56                   	push   %esi
 226:	6a 00                	push   $0x0
 228:	e8 26 01 00 00       	call   353 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 27d:	e8 f9 00 00 00       	call   37b <open>
  if(fd < 0)
 ...
 291:	50                   	push   %eax
 292:	e8 fc 00 00 00       	call   393 <fstat>
  close(fd);
 297:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 29a:	89 c6                	mov    %eax,%esi
  close(fd);
 29c:	e8 c2 00 00 00       	call   363 <close>
  return r;
 ...
 408:	89 d1                	mov    %edx,%ecx
{
 ...
 43b:	0f b6 92 58 08 00 00 	movzbl 0x858(%edx),%edx
 ...
 476:	50                   	push   %eax
 477:	56                   	push   %esi
 478:	e8 de fe ff ff       	call   35b <write>
  while(--i >= 0)
 ...
 4a9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4e0:	50                   	push   %eax
 4e1:	57                   	push   %edi
 4e2:	e8 74 fe ff ff       	call   35b <write>
 ...
 514:	ff 24 85 00 08 00 00 	jmp    *0x800(,%eax,4)
 ...
 540:	57                   	push   %edi
 541:	e8 15 fe ff ff       	call   35b <write>
 ...
 551:	52                   	push   %edx
 552:	57                   	push   %edi
 553:	e8 03 fe ff ff       	call   35b <write>
        putc(fd, c);
 ...
 5bb:	53                   	push   %ebx
 5bc:	57                   	push   %edi
 5bd:	e8 99 fd ff ff       	call   35b <write>
        while(*s != 0){
 ...
 5fa:	52                   	push   %edx
 5fb:	57                   	push   %edi
 5fc:	e8 5a fd ff ff       	call   35b <write>
        ap++;
...
free(void *ap)
{
 ...
 631:	a1 00 0b 00 00       	mov    0xb00,%eax
{
 ...
 686:	72 ce                	jb     656 <free+0x26>
{
 ...
 6a7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 6aa:	a3 00 0b 00 00       	mov    %eax,0xb00
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 15 00 0b 00 00    	mov    0xb00,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70b:	3b 05 00 0b 00 00    	cmp    0xb00,%eax
 711:	75 ed                	jne    700 <malloc+0x40>
  p = sbrk(nu * sizeof(Header));
 713:	83 ec 0c             	sub    $0xc,%esp
 716:	56                   	push   %esi
 717:	e8 a7 fc ff ff       	call   3c3 <sbrk>
  if(p == (char*)-1)
 ...
 72e:	e8 fd fe ff ff       	call   630 <free>
  return freep;
 733:	8b 15 00 0b 00 00    	mov    0xb00,%edx
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 75f:	89 15 00 0b 00 00    	mov    %edx,0xb00
}
 ...
 76f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 777:	0b 00 00 
    base.s.size = 0;
 77a:	b8 04 0b 00 00       	mov    $0xb04,%eax
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 786:	0b 00 00 
    base.s.size = 0;
 789:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 790:	00 00 00 
    if(p->s.size >= nunits){
