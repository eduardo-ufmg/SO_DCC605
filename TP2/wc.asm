...
main(int argc, char *argv[])
{
  ...
  44:	e8 aa 03 00 00       	call   3f3 <close>
  for(i = 1; i < argc; i++){
  ...
  54:	6a 00                	push   $0x0
  56:	ff 33                	push   (%ebx)
  58:	e8 ae 03 00 00       	call   40b <open>
  ...
  70:	e8 bb 04 00 00       	call   530 <printf>
      exit();
  75:	e8 51 03 00 00       	call   3cb <exit>
  }
  exit();
  7a:	e8 4c 03 00 00       	call   3cb <exit>
    wc(0, "");
  7f:	52                   	push   %edx
  80:	52                   	push   %edx
  ...
  88:	e8 13 00 00 00       	call   a0 <wc>
    exit();
  8d:	e8 39 03 00 00       	call   3cb <exit>
  92:	66 90                	xchg   %ax,%ax
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  ...
  aa:	31 db                	xor    %ebx,%ebx
{
  ...
  d0:	e8 0e 03 00 00       	call   3e3 <read>
 ...
 170:	e8 bb 03 00 00       	call   530 <printf>
    exit();
 175:	e8 51 02 00 00       	call   3cb <exit>
 ...
 2a9:	31 db                	xor    %ebx,%ebx
{
 ...
 2b5:	56                   	push   %esi
 2b6:	6a 00                	push   $0x0
 2b8:	e8 26 01 00 00       	call   3e3 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 30d:	e8 f9 00 00 00       	call   40b <open>
  if(fd < 0)
 ...
 321:	50                   	push   %eax
 322:	e8 fc 00 00 00       	call   423 <fstat>
  close(fd);
 327:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 32a:	89 c6                	mov    %eax,%esi
  close(fd);
 32c:	e8 c2 00 00 00       	call   3f3 <close>
  return r;
 ...
 498:	89 d1                	mov    %edx,%ecx
{
 ...
 506:	50                   	push   %eax
 507:	56                   	push   %esi
 508:	e8 de fe ff ff       	call   3eb <write>
  while(--i >= 0)
 ...
 539:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 570:	50                   	push   %eax
 571:	57                   	push   %edi
 572:	e8 74 fe ff ff       	call   3eb <write>
 ...
 5d0:	57                   	push   %edi
 5d1:	e8 15 fe ff ff       	call   3eb <write>
 ...
 5e1:	52                   	push   %edx
 5e2:	57                   	push   %edi
 5e3:	e8 03 fe ff ff       	call   3eb <write>
        putc(fd, c);
 ...
 64b:	53                   	push   %ebx
 64c:	57                   	push   %edi
 64d:	e8 99 fd ff ff       	call   3eb <write>
        while(*s != 0){
 ...
 68a:	52                   	push   %edx
 68b:	57                   	push   %edi
 68c:	e8 5a fd ff ff       	call   3eb <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 7a6:	56                   	push   %esi
 7a7:	e8 a7 fc ff ff       	call   453 <sbrk>
  if(p == (char*)-1)
