...
main(void)
{
  ...
  exit();
   b:	e8 5b 03 00 00       	call   36b <exit>
...
00000010 <printf>:
{
  ...
  28:	e8 5e 03 00 00       	call   38b <write>
}
  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  5c:	6a 01                	push   $0x1
  5e:	e8 28 03 00 00       	call   38b <write>
  ...
  8e:	66 90                	xchg   %ax,%ax
    if(wait() < 0){
  90:	e8 de 02 00 00       	call   373 <wait>
  ...
  if(wait() != -1){
  9e:	e8 d0 02 00 00       	call   373 <wait>
  ...
  be:	6a 01                	push   $0x1
  c0:	e8 c6 02 00 00       	call   38b <write>
}
  ...
  e5:	6a 01                	push   $0x1
  e7:	e8 9f 02 00 00       	call   38b <write>
      exit();
  ec:	e8 7a 02 00 00       	call   36b <exit>
  ...
  fa:	e8 11 ff ff ff       	call   10 <printf>
    exit();
  ff:	e8 67 02 00 00       	call   36b <exit>
 ...
 111:	e8 fa fe ff ff       	call   10 <printf>
    exit();
 116:	e8 50 02 00 00       	call   36b <exit>
