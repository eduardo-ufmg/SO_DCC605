...
main(void)
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
      ...
      2b:	e8 1b 0e 00 00       	call   e4b <open>
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    wait();
      62:	e8 ac 0d 00 00       	call   e13 <wait>
  printf(2, "$ ");
  ...
  exit();
      b2:	e8 54 0d 00 00       	call   e0b <exit>
      close(fd);
      b7:	83 ec 0c             	sub    $0xc,%esp
      ba:	50                   	push   %eax
      bb:	e8 73 0d 00 00       	call   e33 <close>
      break;
      ...
      if(chdir(buf+3) < 0)
      f5:	e8 81 0d 00 00       	call   e7b <chdir>
...
00000170 <panic>:
{
  ...
  exit();
     185:	e8 81 0c 00 00       	call   e0b <exit>
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exec(ecmd->argv[0], ecmd->argv);
     ...
     1dc:	52                   	push   %edx
     1dd:	50                   	push   %eax
     1de:	e8 60 0c 00 00       	call   e43 <exec>
    ...
    exit();
     1f8:	e8 0e 0c 00 00       	call   e0b <exit>
    if(fork1() == 0)
    ...
    if(pipe(p) < 0)
     ...
     211:	50                   	push   %eax
     212:	e8 04 0c 00 00       	call   e1b <pipe>
    ...
    if(fork1() == 0){
     ...
     23f:	6a 00                	push   $0x0
     241:	e8 ed 0b 00 00       	call   e33 <close>
      dup(p[0]);
     246:	5a                   	pop    %edx
     247:	ff 75 f0             	push   -0x10(%ebp)
     24a:	e8 34 0c 00 00       	call   e83 <dup>
      close(p[0]);
     24f:	59                   	pop    %ecx
     250:	ff 75 f0             	push   -0x10(%ebp)
     253:	e8 db 0b 00 00       	call   e33 <close>
      close(p[1]);
     258:	58                   	pop    %eax
     259:	ff 75 f4             	push   -0xc(%ebp)
     25c:	e8 d2 0b 00 00       	call   e33 <close>
      runcmd(pcmd->right);
     261:	58                   	pop    %eax
    ...
    wait();
     273:	e8 9b 0b 00 00       	call   e13 <wait>
    runcmd(lcmd->right);
    ...
    close(rcmd->fd);
     ...
     289:	e8 a5 0b 00 00       	call   e33 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     28e:	58                   	pop    %eax
     28f:	5a                   	pop    %edx
     290:	ff 73 10             	push   0x10(%ebx)
     293:	ff 73 08             	push   0x8(%ebx)
     296:	e8 b0 0b 00 00       	call   e4b <open>
    ...
    close(p[0]);
     ...
     310:	e8 1e 0b 00 00       	call   e33 <close>
    close(p[1]);
     315:	58                   	pop    %eax
     316:	ff 75 f4             	push   -0xc(%ebp)
     319:	e8 15 0b 00 00       	call   e33 <close>
    wait();
     31e:	e8 f0 0a 00 00       	call   e13 <wait>
    wait();
     323:	e8 eb 0a 00 00       	call   e13 <wait>
    break;
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     337:	6a 54                	push   $0x54
     339:	e8 52 0e 00 00       	call   1190 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     367:	6a 18                	push   $0x18
     369:	e8 22 0e 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3b7:	6a 0c                	push   $0xc
     3b9:	e8 d2 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3f7:	6a 0c                	push   $0xc
     3f9:	e8 92 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     437:	6a 08                	push   $0x8
     439:	e8 52 0d 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     469:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     48d:	50                   	push   %eax
     48e:	68 90 19 00 00       	push   $0x1990
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4dd:	50                   	push   %eax
     4de:	68 90 19 00 00       	push   $0x1990
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     536:	50                   	push   %eax
     537:	68 88 19 00 00       	push   $0x1988
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     555:	50                   	push   %eax
     556:	68 90 19 00 00       	push   $0x1990
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 90 19 00 00       	push   $0x1990
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 c9 12 00 00       	push   $0x12c9
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     6c0:	6a 18                	push   $0x18
     6c2:	e8 c9 0a 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     71f:	6a 18                	push   $0x18
     721:	e8 6a 0a 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  return cmd;
     ...
     77e:	68 ac 12 00 00       	push   $0x12ac
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 cc 12 00 00       	push   $0x12cc
     7a4:	56                   	push   %esi
     7a5:	53                   	push   %ebx
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     7bb:	6a 54                	push   $0x54
     7bd:	e8 ce 09 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 e3 12 00 00       	push   $0x12e3
     80b:	56                   	push   %esi
     80c:	53                   	push   %ebx
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 d5 12 00 00       	push   $0x12d5
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 ce 12 00 00       	push   $0x12ce
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 e8 12 00 00       	push   $0x12e8
  cmd = parseexec(ps, es);
  ...
  cmd = malloc(sizeof(*cmd));
     90d:	e8 7e 08 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000940 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     972:	e8 19 08 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 ea 12 00 00       	push   $0x12ea
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 e6 12 00 00       	push   $0x12e6
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9ed:	e8 9e 07 00 00       	call   1190 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 cc 12 00 00       	push   $0x12cc
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 08 13 00 00       	push   $0x1308
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac5:	ff 24 85 50 13 00 00 	jmp    *0x1350(,%eax,4)
     ...
     b55:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     b73:	68 96 12 00 00       	push   $0x1296
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     b9e:	52                   	push   %edx
     b9f:	50                   	push   %eax
     ba0:	68 0a 13 00 00       	push   $0x130a
     ba5:	6a 02                	push   $0x2
     ba7:	e8 c4 03 00 00       	call   f70 <printf>
    panic("syntax");
     bac:	c7 04 24 ce 12 00 00 	movl   $0x12ce,(%esp)
     ...
     ce9:	31 db                	xor    %ebx,%ebx
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     cf5:	56                   	push   %esi
     cf6:	6a 00                	push   $0x0
     cf8:	e8 26 01 00 00       	call   e23 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d4d:	e8 f9 00 00 00       	call   e4b <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d61:	50                   	push   %eax
     d62:	e8 fc 00 00 00       	call   e63 <fstat>
  close(fd);
     d67:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
     d6a:	89 c6                	mov    %eax,%esi
  close(fd);
     d6c:	e8 c2 00 00 00       	call   e33 <close>
  return r;
...
00000e0b <exit>:
SYSCALL(exit)
     e0b:	b8 02 00 00 00       	mov    $0x2,%eax
     e10:	cd 40                	int    $0x40
     e12:	c3                   	ret
...
00000e1b <pipe>:
SYSCALL(pipe)
     e1b:	b8 04 00 00 00       	mov    $0x4,%eax
     e20:	cd 40                	int    $0x40
     e22:	c3                   	ret

00000e23 <read>:
SYSCALL(read)
     e23:	b8 05 00 00 00       	mov    $0x5,%eax
     e28:	cd 40                	int    $0x40
     e2a:	c3                   	ret

00000e2b <write>:
SYSCALL(write)
     e2b:	b8 10 00 00 00       	mov    $0x10,%eax
     e30:	cd 40                	int    $0x40
     e32:	c3                   	ret

00000e33 <close>:
SYSCALL(close)
     e33:	b8 15 00 00 00       	mov    $0x15,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret

00000e3b <kill>:
SYSCALL(kill)
     e3b:	b8 06 00 00 00       	mov    $0x6,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret

00000e43 <exec>:
SYSCALL(exec)
     e43:	b8 07 00 00 00       	mov    $0x7,%eax
     e48:	cd 40                	int    $0x40
     e4a:	c3                   	ret

00000e4b <open>:
SYSCALL(open)
     e4b:	b8 0f 00 00 00       	mov    $0xf,%eax
     e50:	cd 40                	int    $0x40
     e52:	c3                   	ret

00000e53 <mknod>:
SYSCALL(mknod)
     e53:	b8 11 00 00 00       	mov    $0x11,%eax
     e58:	cd 40                	int    $0x40
     e5a:	c3                   	ret

00000e5b <unlink>:
SYSCALL(unlink)
     e5b:	b8 12 00 00 00       	mov    $0x12,%eax
     e60:	cd 40                	int    $0x40
     e62:	c3                   	ret

00000e63 <fstat>:
SYSCALL(fstat)
     e63:	b8 08 00 00 00       	mov    $0x8,%eax
     e68:	cd 40                	int    $0x40
     e6a:	c3                   	ret

00000e6b <link>:
SYSCALL(link)
     e6b:	b8 13 00 00 00       	mov    $0x13,%eax
     e70:	cd 40                	int    $0x40
     e72:	c3                   	ret

00000e73 <mkdir>:
SYSCALL(mkdir)
     e73:	b8 14 00 00 00       	mov    $0x14,%eax
     e78:	cd 40                	int    $0x40
     e7a:	c3                   	ret

00000e7b <chdir>:
SYSCALL(chdir)
     e7b:	b8 09 00 00 00       	mov    $0x9,%eax
     e80:	cd 40                	int    $0x40
     e82:	c3                   	ret

00000e83 <dup>:
SYSCALL(dup)
     e83:	b8 0a 00 00 00       	mov    $0xa,%eax
     e88:	cd 40                	int    $0x40
     e8a:	c3                   	ret

00000e8b <getpid>:
SYSCALL(getpid)
     e8b:	b8 0b 00 00 00       	mov    $0xb,%eax
     e90:	cd 40                	int    $0x40
     e92:	c3                   	ret

00000e93 <sbrk>:
SYSCALL(sbrk)
     e93:	b8 0c 00 00 00       	mov    $0xc,%eax
     e98:	cd 40                	int    $0x40
     e9a:	c3                   	ret

00000e9b <sleep>:
SYSCALL(sleep)
     e9b:	b8 0d 00 00 00       	mov    $0xd,%eax
     ea0:	cd 40                	int    $0x40
     ea2:	c3                   	ret

00000ea3 <uptime>:
SYSCALL(uptime)
     ea3:	b8 0e 00 00 00       	mov    $0xe,%eax
     ea8:	cd 40                	int    $0x40
     eaa:	c3                   	ret
     ...
     ed8:	89 d1                	mov    %edx,%ecx
{
  ...
  write(fd, &c, 1);
     ...
     f46:	50                   	push   %eax
     f47:	56                   	push   %esi
     f48:	e8 de fe ff ff       	call   e2b <write>
  while(--i >= 0)
     ...
     f79:	8b 75 0c             	mov    0xc(%ebp),%esi
{
  ...
  write(fd, &c, 1);
     ...
     fb0:	50                   	push   %eax
     fb1:	57                   	push   %edi
     fb2:	e8 74 fe ff ff       	call   e2b <write>
  ...
  write(fd, &c, 1);
    ...
    1010:	57                   	push   %edi
    1011:	e8 15 fe ff ff       	call   e2b <write>
    ...
    1021:	52                   	push   %edx
    1022:	57                   	push   %edi
    1023:	e8 03 fe ff ff       	call   e2b <write>
        putc(fd, c);
  ...
  write(fd, &c, 1);
    ...
    108b:	53                   	push   %ebx
    108c:	57                   	push   %edi
    108d:	e8 99 fd ff ff       	call   e2b <write>
        while(*s != 0){
  ...
  write(fd, &c, 1);
    ...
    10ca:	52                   	push   %edx
    10cb:	57                   	push   %edi
    10cc:	e8 5a fd ff ff       	call   e2b <write>
        ap++;
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11e6:	56                   	push   %esi
    11e7:	e8 a7 fc ff ff       	call   e93 <sbrk>
  if(p == (char*)-1)
