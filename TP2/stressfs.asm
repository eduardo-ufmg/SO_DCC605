  ...
  1b:	31 db                	xor    %ebx,%ebx
{
  ...
  98:	e8 0e 03 00 00       	call   3ab <open>
...
//    printf(fd, "%d\n", i);
  ...
  b0:	56                   	push   %esi
  b1:	57                   	push   %edi
  b2:	e8 d4 02 00 00       	call   38b <write>
  for(i = 0; i < 20; i++)
  ...
  c2:	57                   	push   %edi
  c3:	e8 cb 02 00 00       	call   393 <close>
  ...
  e5:	50                   	push   %eax
  e6:	e8 c0 02 00 00       	call   3ab <open>
  ...
  f8:	56                   	push   %esi
  f9:	57                   	push   %edi
  fa:	e8 84 02 00 00       	call   383 <read>
  for (i = 0; i < 20; i++)
 ...
 10a:	57                   	push   %edi
 10b:	e8 83 02 00 00       	call   393 <close>

  wait();
 110:	e8 5e 02 00 00       	call   373 <wait>

  exit();
 115:	e8 51 02 00 00       	call   36b <exit>
 ...
 249:	31 db                	xor    %ebx,%ebx
{
 ...
 255:	56                   	push   %esi
 256:	6a 00                	push   $0x0
 258:	e8 26 01 00 00       	call   383 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2ad:	e8 f9 00 00 00       	call   3ab <open>
  if(fd < 0)
 ...
 2c1:	50                   	push   %eax
 2c2:	e8 fc 00 00 00       	call   3c3 <fstat>
  close(fd);
 ...
 438:	89 d1                	mov    %edx,%ecx
{
 ...
 4a6:	50                   	push   %eax
 4a7:	56                   	push   %esi
 4a8:	e8 de fe ff ff       	call   38b <write>
  while(--i >= 0)
 ...
 4d9:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 510:	50                   	push   %eax
 511:	57                   	push   %edi
 512:	e8 74 fe ff ff       	call   38b <write>
 ...
 570:	57                   	push   %edi
 571:	e8 15 fe ff ff       	call   38b <write>
 ...
 581:	52                   	push   %edx
 582:	57                   	push   %edi
 583:	e8 03 fe ff ff       	call   38b <write>
        putc(fd, c);
 ...
 5eb:	53                   	push   %ebx
 5ec:	57                   	push   %edi
 5ed:	e8 99 fd ff ff       	call   38b <write>
        while(*s != 0){
 ...
 62a:	52                   	push   %edx
 62b:	57                   	push   %edi
 62c:	e8 5a fd ff ff       	call   38b <write>
        ap++;
...
malloc(uint nbytes)
{
 ...
 746:	56                   	push   %esi
 747:	e8 a7 fc ff ff       	call   3f3 <sbrk>
  if(p == (char*)-1)
